...
func ToStringMapE(o any) (map[string]any, error) {
	return toMapE[map[string]any](o, ToStringE[string], func(o any) (any, error) { return o, nil })
}

// ToStringMapStringE casts an interface to a map[string]string type.
func ToStringMapStringE(o any) (map[string]string, error) {
	return toMapE[map[string]string](o, ToStringE[string], ToStringE[string])
}

// ToStringMapBoolE casts an interface to a map[string]bool type.
func ToStringMapBoolE(o any) (map[string]bool, error) {
	return toMapE[map[string]bool](o, ToStringE[string], ToBoolE[bool])
}

// ToStringMapIntE casts an interface to a map[string]int{} type.
func ToStringMapIntE(o any) (map[string]int, error) {
	return toMapE[map[string]int](o, ToStringE[string], ToSignedE[int])
}

// ToStringMapInt64E casts an interface to a map[string]int64{} type.
func ToStringMapInt64E(o any) (map[string]int64, error) {
	return toMapE[map[string]int64](o, ToStringE[string], ToSignedE[int64])
}

// ToStringMapStringSliceE casts an interface to a map[string][]string type.
func ToStringMapStringSliceE(o any) (map[string][]string, error) {
	return toMapE[map[string][]string](o, ToStringE[string], ToStringSliceE[[]string])
}
